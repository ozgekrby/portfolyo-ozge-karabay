  ...
  return (dispatch) => {
    ...
    axios
      ...
      .then(function (response) {
        ...
        dispatch({
          type: "SET_DATA",
          payload: { section: "modeSwitch", data: modeSwitchData },
        });
        dispatch({
          type: "SET_DATA",
          payload: { section: "header", data: headerData },
        });
        dispatch({
          type: "SET_DATA",
          payload: { section: "hero", data: heroData },
        });
        dispatch({
          type: "SET_DATA",
          payload: { section: "skills", data: skillsData },
        });
        dispatch({
          type: "SET_DATA",
          payload: { section: "profile", data: profileData },
        });
        dispatch({
          type: "SET_DATA",
          payload: { section: "projects", data: projectsData },
        });
        dispatch({
          type: "SET_DATA",
          payload: { section: "footer", data: footerData },
        });
        dispatch({
          type: "SET_DATA",
          payload: { section: "titles", data: titlesData },
        });
      })
